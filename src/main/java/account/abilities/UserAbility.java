package account.abilities;

import shared.abilities.ActionNameCode;

public class UserAbility {
    public final static String _PATH = "/api/v1/account/users";
    public final static String _ABILITY_TITLE = "Gestion des utilisateurs";
    public final static String _ABILITY_DESC = "Donne toutes opérations qui sont liées á la gestion des utilisateurs, roles et permissions";
    protected final static String _ABILITY_CODE = "USER:";
    protected   final static String _ABILITY_NAME = "Utilisateur";
